...
# filtered dataframe with 4 most at-r-sk districts: Mafeteng, Mohale’s Hoek, Thaba-Tseka, and Quthing
...
server <- function(input, output, session) {
  ...
  # Same as main page map, but only highlighting the most at-risk districts (Mafeteng, Mohale’s Hoek, Thaba-Tseka, and Quthing)
