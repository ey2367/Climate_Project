...
df_lab <- data.frame(
  ...
  Lat = c(-30.4001, -30.15, -30.1167, -29.8167, -29.31, -29.5333, -29.2885, -29.2069, -28.8734, -28.7833),
  Long = c(27.7002, 27.4667, 28.6833, 27.25, 27.48, 28.6, 29.0656, 27.878, 28.0416, 28.2333)
)
...
df_pop <- read.csv("~/Desktop/Columbia/Fall 23/Practicum/lesotho_pop_short.csv")
```
