       ...
       box(title = "Map Viewing Options", width = NULL, height = 500,
        ...
        selectInput("Trigger_Level", # create a dropdown menu for user to select input
              ...
              choices = c("Mild" = 1,
                          "Moderate" = 2, 
                          "Severe" = 3),
              selected = 1 # the default option to "Mild"
  ),
  uiOutput("lesotho_month"),
        selectInput("Month", # create a dropdown menu for user to select input
              label = "Month", 
              choices = c("June" = 1,
                          "July" = 2, 
                          "August" = 3),
...
# Build reactive user input for forecast viewing  
 selected_severity <- reactive({
    ...
    ondgeojson$ColorFcst <- cut(ondgeojson$RainFcstV2, 
                       ...
                       labels = c("darkred", "firebrick", "red", "orangered", "darkorange", "orange", "gold", "khaki"),
                       include.lowest = TRUE)
