...
# Load in shaoefiles for district boundaries
...
# Create Dataframe (using Annex 1 - AA Timeline from AAP Template)
...
# Create Dataframe (using Annex 3 - Readiness Measures from AAP Template)
...
body <- dashboardBody(use_theme(my_theme),
    ...
    tabItem(tabName = "dashboard", #assign section
      ...
      column(width = 3, # build map viewing options
       box(title = tags$strong("Map Viewing Options", style = "font-size: 19px;"), width = NULL, height = 500,
        ...
        selectInput("Select_Level", # create a dropdown menu for user to select viewing level
              label = "Mode", 
        ...
        selectInput("Select_Month", # create a dropdown menu for user to select forecasted month
              label = "Month", 
              choices = c("June" = 1,
                          "July" = 2, 
                          "August" = 3),
  ...
  uiOutput("lesotho_forecast"),
        selectInput("Trigger_Level", # create a dropdown menu for user to select severity level
              label = "Severity", 
              choices = c("Mild" = 1,
                          "Moderate" = 2, 
                          "Severe" = 3),
  ...
  p(class = "text-muted",
       ...
       fluidRow(column(width = 12,
        box(title = "", width = NULL, height = 650, plotlyOutput("fig")), # add Gantt Chart to main dashbaord page
...
#         #   ))
    ...
    tabItem(tabName = "actions",
      fluidRow(column(width = 12,
        box(title = "", width = NULL, height = 850, plotlyOutput("fig2"))), # Add anticipatory actions Gantt Chart
        ),
      fluidRow(column(width = 12,
    ...
    fluidRow(column(width = 12,
        box(title = tags$strong("Anticipatory Action Implementation Organizations", style = "font-size: 19px;"), width = NULL, height = 700, tableOutput("organization_table"))) # add table to describe organizations
        )
    ),
...
tabItem(tabName = "data",
  ...
  tabItem(tabName = "risk",
      ...
      fluidRow(column(width = 12,
        box(title = tags$strong("Council & Geographic Information", style = "font-size: 21px;"), width = NULL, height = 450,
    ...
    tabItem(tabName = "guide",
      ...
      fluidRow(column(width = 12, # add section for supporting materials
        box(title = tags$strong("Supporting Materials", style = "font-size: 21px;"), width = NULL, height = 500)
      ))
    )
))
...
# render organization information table 
output$organization_table <- renderTable({
        df_organizations
    })
...
# build district population graph for Additonal Information tab
